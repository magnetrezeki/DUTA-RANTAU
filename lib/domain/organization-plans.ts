...
|'admin.multiple'|'branch.multiple'|'report.advanced'|'brand.manage'|'promotion.manage'|'commercial.tools'|'payment.partner_tools'|'analytics.view'|'meeting.audio_summary';
...
{id:'PRO',name:'DUTA ORGANISASI PRO',priceMyr:99.90,period:'month',description:'Operasional, komunikasi, dan pertumbuhan skala lanjut.',features:['Semua fitur Organisasi+','Multi-admin','Multi-cabang','Laporan lanjutan','Branding organisasi','Promosi','Alat komersial','Koneksi pembayaran mitra','Analytics','Audio rapat ke transkrip dan ringkasan'],entitlements:[...plus,'admin.multiple','branch.multiple','report.advanced','brand.manage','promotion.manage','commercial.tools','payment.partner_tools','analytics.view','meeting.audio_summary']}
];
