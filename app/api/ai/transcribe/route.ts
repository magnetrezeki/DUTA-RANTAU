...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (!result.success) return NextResponse.json({ error: "Transkripsi belum tersedia. Silakan ketik pertanyaan Anda.", code: "TRANSCRIPTION_PROVIDER_UNAVAILABLE" }, { status: 503 });
